...
import com.tripoin.kawaii.util.parameter.IParamComponent;
import com.tripoin.kawaii.util.parameter.ParamFTPServer;
...
public class FTPConnection implements IFTPConnection, IParamComponent<ParamFTPServer> {
    ...
    private Logger logger = Logger.getLogger(FTPConnection.class);
